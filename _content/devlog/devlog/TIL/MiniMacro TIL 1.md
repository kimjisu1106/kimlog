...
date: 2026-08-15
permalink: "devlog/devlog/TIL/MiniMacro TIL 1"
categories:
  - today-i-learn
...
tags:
  - Python
---
마우스·키보드 반복 작업 자동화 툴 MiniMacro(Python + tkinter)를 만들었다. tkinter는 파이썬에 기본으로 들어 있는 GUI 툴킷이다 — 창·버튼 같은 화면 요소를 코드로 만든다. 함정은 클릭을 흉내 내는 코드가 아니라 좌표계(DPI·듀얼 모니터)와 스레드 경계에 있었다. 정리한다.
