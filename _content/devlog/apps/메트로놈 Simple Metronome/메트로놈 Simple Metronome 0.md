...
- 출시가 끝이 아니라, 이후에도 테마·박자표 UI·프리셋·사운드·비트 플래시·다국어·백그라운드 재생을 더하며 v1.14까지 이어왔다.
...
- v1.14로 프로덕션 출시 상태이며, 출시 후에도 테마·박자표·프리셋·사운드·백그라운드 재생 등으로 업데이트해 왔다.
