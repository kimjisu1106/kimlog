...
17. (유료·네이티브) 4K 내보내기 + 저지연 라이브 연주 + 투명 배경(알파) 내보내기 — 알파를 담을 수 있는 WebM은 재생 호환성이 떨어져 유료 쪽에서 제대로 다루기로 ⏳
...
- 남긴 것: 저지연 라이브 연주와 투명 배경(알파) 내보내기는 유료·네이티브 앱 몫. 알파를 담는 WebM이 재생 호환성이 떨어져, 무료 웹은 MP4 1080p로 정리했다
