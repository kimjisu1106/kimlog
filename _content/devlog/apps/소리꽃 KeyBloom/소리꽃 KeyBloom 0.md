...
- 버전 방향
    - MVP = 무료 버전 출시(웹). 고화질 오프라인 MP4 내보내기(1080p) 포함, 내보낸 영상엔 워터마크
    - 유료·네이티브 = 워터마크 제거 + 4K 내보내기 + 저지연 실시간 연주 + 투명 배경 오프라인 — 웹 오디오/코덱 한계 돌파
...
17. (유료·네이티브) 4K 내보내기 + 저지연 라이브 연주 + 투명 배경 오프라인 — 웹 오디오/코덱 한계 돌파 ⏳
